...
shape_unet.load_state_dict(torch.load('models/modelo2.pth', map_location=device))
shape_unet.eval()
...
# Guardar salida
nombre_salida = os.path.splitext(os.path.basename(img_path))[0] + '_analizada_mod2.jpg'
